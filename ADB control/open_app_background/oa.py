...
def go():
    ...
    while 1:
        ...
        if idx < 21:
            ...
            ope_funcs.log(f"{package_name}_{android_time.get_android_time(honor_device_id)}", "open_app_background/oa_log.txt")
            ...
            # ope_funcs.send_swipe(honor_device_id, (1100, 2340), (1100, 1900), 100)
            # ope_funcs.send_swipe(honor_device_id, (700, 2340), (700, 1900), 100)
            # ope_funcs.send_swipe(honor_device_id, (1400, 2340), (1400, 1900), 100)
            # ope_funcs.send_swipe(honor_device_id, (10, 2000), (250, 2000), 200)
            # ope_funcs.send_swipe(honor_device_id, (10, 2000), (250, 2000), 200)
            # ope_funcs.send_swipe(honor_device_id, (10, 2000), (250, 2000), 200)
            # time.sleep(0.2)

            # three times tap home, 2 * back
            tap_home_back(2, 2)
            ...
            if True:
                ope_funcs.tap_xy(honor_device_id, ox, oy)
                time.sleep(0.5)
                tap_home_back(4, 2)
                time.sleep(2)
